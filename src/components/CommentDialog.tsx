...
const CommentDialog = ({ interviewId }: { interviewId: Id<"interviews"> }) => {
  ...
  const existingComment = useQuery(api.comments.getComments, { interviewId });
  ...
  if (existingComment === undefined || users === undefined) return null;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[35rem] overflow-auto">
        <DialogHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline">
                  {existingComment.length} Comment
                  {existingComment.length !== 1 ? "s" : ""}
                </Badge>
              </div>
              ...
              <ScrollArea className="h-[240px]">
                <div className="space-y-4">
                  {existingComment.map((comment, index) => {
